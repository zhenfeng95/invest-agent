...
- **正文只保留连续 §0–§8**（**§0**=一句话总结 + 分层要点四块：指数与均线 / 结构与驱动 / 赚钱效应与量能 / 结论；**禁止**§0 长段堆砌；§1 含状态评分 + 交易结论；**赚钱效应行内含**全市场涨跌家数 + **涨跌中位数 vs 上证**（`market_breadth.py`）+ **成交额前100涨:跌**（仅家数，`top100_amount.py`）+ 涨跌停/连板；**禁止**另开活跃成交/前100行业分布专节；§4=**资金与板块共振**：4.1 行业线资金×涨跌 / 4.2 概念线资金×涨跌 / 4.3 交叉轮动；§5=持仓+近7日负面；§6=明日应对五要点；§7=用户池；§8=结论）；禁止跳号；禁止再单开「今日资金面 / 板块表现 / 主题概念 / 持仓负面 / 轮动」专章
