...
> **输出**：`output/research/weekly/weekly-YYYY-Www.md`
...
```text
按 templates/weekly-review.md 生成 2026-W36 周度回顾，保存到 output/research/weekly/weekly-2026-W36.md
```

或：

```text
参照 scheduler/prompt-weekly-review.md 的结构和口径，复盘本周 A股+美股组合表现；写入 output/research/weekly/
```
...
| 输出 | `output/research/weekly/` | `output/reviews/` |
